      ...
      <div className="flex items-center justify-between">
        <div>
          <span className="flex items-center px-2">
            <BsChevronLeft className="cursor-pointer mr-3" />
            <p>Shang-Chi and the Legend of the Ten Rings</p>
          </span>
        </div>
        <div>
          <IoShareSocialOutline className="cursor-pointer w-5 h-5" />
        </div>
      </div>
    </>
  );
    ...
    <>
      <div className="container mx-auto px-3 flex items-center justify-between">
        <div className="flex items-center w-3/5 gap-5">
          ...
          <div className="w-full flex items-center bg-white gap-4 px-3 py-2 rounded-md cursor-pointer">
            <BsSearch />
            <input
              type="search"
        ...
        <div className="flex items-center gap-4">
          <span className="text-gray-400 flex items-center  hover:text-white transition duration-300 cursor-pointer gap-1">
            Thiruthuraipoondi <FiChevronDown />
          </span>
          <button className="bg-red-500 px-3.5 py-1 text-white text-sm rounded cursor-pointer">
            Sign in
          </button>
          <div className="w-8 h-8 text-white">
            <HiOutlineMenu className="w-full h-full cursor-pointer" />
          </div>
        </div>
      </div>
    </>
...
const MovieNavbar = () => {
  return (
    <>
      <nav className="bg-gray-200 lg:bg-navColor-750 p-3 sm:mb-2 lg:mb-0">
